...
#else
// no-exceptions: this function never returns
inline YAML_CPP_NORETURN void handle_exception(const char* what) {
  (void)what;    // suppress unused warning
    __builtin_unreachable();
}

template <typename Ex, typename... Args>
inline YAML_CPP_NORETURN void YAML_throw(Args&&... args) {
